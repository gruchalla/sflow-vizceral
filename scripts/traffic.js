...
var defaultGroups = {
  'INTERNET': ['0.0.0.0/0'],
//  'INL': ['III.III.III.III/32'],
//  'ORNL': ['OOO.OOO.OOO.OOO/32'],
  'PNNL': ['PPP.PPP.PPP.PPP/32'],
  'NREL': ['NNN.NNN.NNN.NNN/32'],
};
var groups = storeGet('groups') || defaultGroups;

var metadata = {
  'INTERNET': { position: {x: -430, y: -30} },
//  'INL': { position: {x: -188, y: 70} },
//  'ORNL': { position: {x: 510, y: -167}},
  'PNNL': { position: {x: -340, y: 230}},
  'NREL': { position: {x: -58, y: -70}},
}
...
function getGroup(group,flows_in,flows_out) {
  var flows = {renderer:'region',name:group,class:'normal',metadata:metadata[group],nodes:[],connections:[]};
  var nodes = {};
...
function getFlows() {
  var data = {
    ...
    updated: Date.now(),
    entryNode:'INTERNET',
    nodes: [{renderer:'region', name:'INTERNET', metadata:metadata['INTERNET'], class:'normal'}],
    connections: [] 
  };
